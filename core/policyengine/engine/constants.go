...
const (
	...
	SF_NET_SOURCE_HOST_NAME string = "sf.net.shostname"
	SF_NET_SOURCE_PORT_NAME string = "sf.net.sportname"
	SF_NET_DEST_HOST_NAME   string = "sf.net.dhostname"
	SF_NET_DEST_PORT_NAME	string = "sf.net.dportname"
	...
	SF_FLOW_DURATION		string = "sf.flow.duration"
	...
	SF_CONTAINER_IMAGEREPO		string = "sf.container.image.repository"
