...
const (
	...
	CONT_IMAGEREPO_STR    Attribute = CONT_IMAGEID_STR + 1
	CONT_MOUNT_SOURCE_STR Attribute = CONT_IMAGEREPO_STR + 1
	...
	CONT_HOSTPORT_STR	  	   Attribute = CONT_MOUNT_PROPAGATION_STR + 1
	CONT_CONTAINERPORT_STR	   Attribute = CONT_HOSTPORT_STR + 1
	CONT_TYPE_INT         Attribute = SFHE_VERSION_INT + 1
	CONT_PRIVILEGED_INT   Attribute = CONT_TYPE_INT + 1
	CONT_PODID_STRING_STR Attribute = CONT_CONTAINERPORT_STR + 1
	...
	FL_FILE_GAPTIME_INT       Attribute = FL_FILE_NUMWSENDBYTES_INT + 1
	FL_FILE_DURARION_INT 	  Attribute = FL_FILE_GAPTIME_INT + 1
	FL_FILE_OPENFLAGS_INT     Attribute = FL_FILE_DURARION_INT + 1
	...
	FL_NETW_GAPTIME_INT       Attribute = FL_NETW_NUMWSENDBYTES_INT + 1
	FL_NETW_DURATION_INT	  Attribute = FL_NETW_GAPTIME_INT + 1
	FL_NETW_SIP_INT           Attribute = FL_NETW_DURATION_INT + 1
	...
	// FL_NETW_SOURCE_HOST_NAME_STR	Attribute = SEC_FILE_CONTAINERID_STRING_STR + 1
	// FL_NETW_DEST_HOST_NAME_STR		Attribute = FL_NETW_SOURCE_HOST_NAME_STR + 1
	// FL_NETW_SOURCE_PORT_NAME_STR	Attribute = FL_NETW_DEST_HOST_NAME_STR + 1
	// FL_NETW_DEST_PORT_NAME_STR		Attribute = FL_NETW_SOURCE_PORT_NAME_STR + 1
